...
@injectable()
export class SendGroupMessageCommand {
    ...
    static setProperties(cmd: SendGroupMessageCommand): SendGroupMessageCommand {
        return plainToClass(SendGroupMessageCommand, cmd, {
